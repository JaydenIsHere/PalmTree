      ...
      <div className='contact-section'>
        <div className='container grid grid-1 text-center py-3'>
          ...
          <div className='contactUsP'>
            <p>
              You got questions, we got answers to anything related to Palm
              Tree!{' '}
            </p>
            <p>
              Our team is here to help - Reach us via the form below and we will
        ...
        <form action='#' className='flex container'>
          <div className='form-size'>
            ...
            <input type='submit' value='Submit' className='btn2 btn-dg' />
          </div>
        </form>
      </div>
    </section>
